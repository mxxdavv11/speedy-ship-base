        ...
        <div className="max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            {[
              ...
              <AccordionItem key={index} value={`item-${index}`} className="rounded-2xl shadow-sm ring-1 bg-white border-0 overflow-hidden" style={{ borderColor: '#E5E7EB' }}>
                <AccordionTrigger className="px-6 py-4 text-left hover:no-underline hover:bg-gray-50" style={{ color: COLORS.dark }}>
